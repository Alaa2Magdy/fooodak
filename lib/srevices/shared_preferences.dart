...
class SharedPreferencesDatabase {
  ...
  /*Refactoring  - Uncommunicative Name */
  /*static Future<bool> saveulk(bool isLoggedIn) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setBool(
        _sharedPreferencesIsLoggedInKey, isLoggedIn);
  }*/
  ...
  static Future<bool> saveUserNameKey(String isUserName) async {
    ...
    return await preferences.setString(
        _sharedPreferencesUserNameKey, isUserName);
  }
