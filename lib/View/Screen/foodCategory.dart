...
List images =[
  Image.asset("images/16.png",fit: BoxFit.fill,)
  ,Image.asset("images/17.png",fit: BoxFit.fill,)
  ,Image.asset("images/18.png",fit:BoxFit.fill,),
  Image.asset("images/19.png",fit:BoxFit.fill,),
  Image.asset("images/20.png",fit:BoxFit.fill,)];
List titels =["Fries","Pizza","Burger","Pasta","Salad"];
// List inks=[InkWell(onTap: (){},),
//   InkWell(onTap: (){Navigator.pushNamed(context as BuildContext,PizzaMeals.id);},),
//   InkWell(onTap: (){Navigator.pushNamed(context as BuildContext,BurgerMeals.id);},),
//   InkWell(onTap: (){Navigator.pushNamed(context as BuildContext,FirstScreen.id);},),
//   InkWell(onTap: (){})];
class FoodCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return sectionCard(
    icon: images[index], titel: titels[index],inks:inks[index]);
    }),),
    ),
